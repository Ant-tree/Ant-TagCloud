 ...
 */
public class AntTagCloudView extends RecyclerView {
    boolean expanded = true;

    public AntTagCloudView(Context context) {
        super(context);
        this.setFadingEdgeLength(0);
        this.setOverScrollMode(OVER_SCROLL_NEVER);
    }

    public AntTagCloudView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.setFadingEdgeLength(0);
        this.setOverScrollMode(OVER_SCROLL_NEVER);
    }

    public AntTagCloudView(Context context, AttributeSet attrs, int defStyle) {
